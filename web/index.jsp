    ...
    <div class="container">
      <div>
        ...
        <article class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="margin-bottom: 40px;">
          <p>
            <img src="img/encuentra.jpg" align="left" height="55px" style="margin-bottom: 10px"  class="visible-xs">
            <img src="img/encuentra.jpg" align="left" height="60px" style="margin-bottom: 10px"  class="visible-sm">
            <img src="img/encuentra.jpg" align="left" height="45px" style="margin-bottom: 10px"  class="visible-md">
            <img src="img/encuentra.jpg" align="left" height="55px" style="margin-bottom: 10px"  class="visible-lg">
        ...
        <article class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="margin-bottom: 40px;">
          <p>
            <img src="img/libertad.jpg" align="left" height="55px" style="margin-bottom: 10px"  class="visible-xs">
            <img src="img/libertad.jpg" align="left" height="60px" style="margin-bottom: 10px"  class="visible-sm">
            <img src="img/libertad.jpg" align="left" height="45px" style="margin-bottom: 10px"  class="visible-md">
            <img src="img/libertad.jpg" align="left" height="55px" style="margin-bottom: 10px"  class="visible-lg">
          ...
          <div class="container">
              <div>
                  <div class="container" style="margin-top: 40px; margin-bottom: 15px;">
                      ...
                      <p align="left" style="color: #303030; font-size: 17px;">Asesorate con los mejores <br>cuando estes a punto de sustentar.<br>¡Vive nuevas experiencia!</p><br><br>
                  </div>
              </div>
          </div>
      </div>
